module.exports = {table:
{
  ...
  "*dataBlockValue" : {
     ...
     "TRIPLE_REF": ["dataBlockValue","*dataBlockValue"],
     "EMB_TRIPLE_REF": ["dataBlockValue","*dataBlockValue"],
  ...
  "*graphNode" : {
     ...
     "TRIPLE_REF": ["graphNode","*graphNode"],
     "EMB_TRIPLE_REF": ["graphNode","*graphNode"],
  ...
  "*graphNodePath" : {
     ...
     "TRIPLE_REF": ["graphNodePath","*graphNodePath"],
     "EMB_TRIPLE_REF": ["graphNodePath","*graphNodePath"],
  ...
  "*groupCondition" : {
     ...
     "TRIPLE_REF": ["groupCondition","*groupCondition"],
     "EMB_TRIPLE_REF": ["groupCondition","*groupCondition"],
  ...
  "*orderCondition" : {
     ...
     "TRIPLE_REF": ["orderCondition","*orderCondition"],
     "EMB_TRIPLE_REF": ["orderCondition","*orderCondition"],
  ...
  "*varOrIRIref" : {
     ...
     "TRIPLE_REF": ["varOrIRIref","*varOrIRIref"],
     "EMB_TRIPLE_REF": ["varOrIRIref","*varOrIRIref"],
  ...
  "+havingCondition" : {
     ...
     "NOT": ["havingCondition","*havingCondition"], 
     "IRI_REF": ["havingCondition","*havingCondition"],
     "TRIPLE_REF": ["havingCondition","*havingCondition"],
     "EMB_TRIPLE_REF": ["havingCondition","*havingCondition"],
     "PNAME_LN": ["havingCondition","*havingCondition"], 
     "PNAME_NS": ["havingCondition","*havingCondition"]}, 
  "+or([var,[(,expression,AS,var,)]])" : {
     "(": ["or([var,[(,expression,AS,var,)]])","*or([var,[(,expression,AS,var,)]])"], 
  ...
  "?[or([verbPath,verbSimple]),objectList]" : {
     ...
     "TRIPLE_REF": ["[or([verbPath,verbSimple]),objectList]"],
     "EMB_TRIPLE_REF": ["[or([verbPath,verbSimple]),objectList]"],
  ...
  "?[pathOneInPropertySet,*[|,pathOneInPropertySet]]" : {
     ...
     "TRIPLE_REF": ["[pathOneInPropertySet,*[|,pathOneInPropertySet]]"],
     "EMB_TRIPLE_REF": ["[pathOneInPropertySet,*[|,pathOneInPropertySet]]"],
  ...
  "?constructTriples" : {
     ...
     "TRIPLE_REF": ["constructTriples"],
     "EMB_TRIPLE_REF": ["constructTriples"],
  ...
  "?triplesBlock" : {
     ...
     "TRIPLE_REF": ["triplesBlock"],
     "EMB_TRIPLE_REF": ["triplesBlock"],
     "TRUE": ["triplesBlock"], 
     "FALSE": ["triplesBlock"], 
  ...
  "?triplesTemplate" : {
     ...
     "TRIPLE_REF": ["triplesTemplate"],
     "EMB_TRIPLE_REF": ["triplesTemplate"],
  ...
  "additiveExpression" : {
     ...
     "TRIPLE_REF": ["multiplicativeExpression","*or([[+,multiplicativeExpression],[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),?or([[*,unaryExpression],[/,unaryExpression]])]])"],
     "EMB_TRIPLE_REF": ["multiplicativeExpression","*or([[+,multiplicativeExpression],[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),?or([[*,unaryExpression],[/,unaryExpression]])]])"],
  ...
  "conditionalAndExpression" : {
     ...
     "TRIPLE_REF": ["valueLogical","*[&&,valueLogical]"],
     "EMB_TRIPLE_REF": ["valueLogical","*[&&,valueLogical]"],
  ...
  "conditionalOrExpression" : {
     ...
     "TRIPLE_REF": ["conditionalAndExpression","*[||,conditionalAndExpression]"],
     "EMB_TRIPLE_REF": ["conditionalAndExpression","*[||,conditionalAndExpression]"],
  ...
  "constraint" : {
     ...
     "TRIPLE_REF": ["functionCall"],
     "EMB_TRIPLE_REF": ["functionCall"],
  ...
  "constructTriples" : {
     ...
     "TRIPLE_REF": ["triplesSameSubject","?[.,?constructTriples]"],
     "EMB_TRIPLE_REF": ["triplesSameSubject","?[.,?constructTriples]"],
  ...
  "dataBlockValue" : {
     "IRI_REF": ["iriRef"],
     "TRIPLE_REF": ["embTripleRef"],
     "EMB_TRIPLE_REF": ["embTripleRef"],
     "PNAME_LN": ["iriRef"], 
     "PNAME_NS": ["iriRef"], 
  ...
  "expression" : {
     ...
     "TRIPLE_REF": ["conditionalOrExpression"],
     "EMB_TRIPLE_REF": ["conditionalOrExpression"],
  ...
  "functionCall" : {
     ...
     "TRIPLE_REF": ["embTripleRef","argList"],
     "EMB_TRIPLE_REF": ["embTripleRef","argList"],
  ...
  "graphNode" : {
     ...
     "NIL": ["varOrTerm"], 
     "IRI_REF": ["varOrTerm"],
     "TRIPLE_REF": ["varOrTerm"],
     "EMB_TRIPLE_REF": ["varOrTerm"],
     "TRUE": ["varOrTerm"], 
     "FALSE": ["varOrTerm"], 
  ...
  "groupGraphPatternSub" : {
     ...
     "TRIPLE_REF": ["?triplesBlock","*[graphPatternNotTriples,?.,?triplesBlock]"],
     "EMB_TRIPLE_REF": ["?triplesBlock","*[graphPatternNotTriples,?.,?triplesBlock]"],
  ...
  "havingCondition" : {
     ...
     "NOT": ["constraint"], 
     "IRI_REF": ["constraint"],
     "TRIPLE_REF": ["constraint"],
     "EMB_TRIPLE_REF": ["constraint"],
     "PNAME_LN": ["constraint"], 
     "PNAME_NS": ["constraint"]}, 
  "inlineData" : {
  ...
  "integer" : {
     "INTEGER": ["INTEGER"]},
   "embTripleRef" : {
      "TRIPLE_REF": ["TRIPLE_REF"],
      "EMB_TRIPLE_REF": ["EMB_TRIPLE_REF"]
   },
   "embTripleRefOrFunction" : {
      "TRIPLE_REF": ["embTripleRef","?argList"],
      "EMB_TRIPLE_REF": ["embTripleRef","?argList"]
   },
  "iriRef" : {
  ...
  "multiplicativeExpression" : {
     ...
     "TRIPLE_REF": ["unaryExpression","*or([[*,unaryExpression],[/,unaryExpression]])"],
     "EMB_TRIPLE_REF": ["unaryExpression","*or([[*,unaryExpression],[/,unaryExpression]])"],
  ...
  "numericExpression" : {
     ...
     "TRIPLE_REF": ["additiveExpression"],
     "EMB_TRIPLE_REF": ["additiveExpression"],
  ...
  "object" : {
     ...
     "NIL": ["graphNode"], 
     "IRI_REF": ["graphNode"],
     "TRIPLE_REF": ["graphNode"],
     "EMB_TRIPLE_REF": ["graphNode"],
     "TRUE": ["graphNode"], 
     "FALSE": ["graphNode"], 
  ...
  "objectList" : {
     ...
     "TRIPLE_REF": ["object","*[,,object]"],
     "EMB_TRIPLE_REF": ["object","*[,,object]"],
     "TRUE": ["object","*[,,object]"], 
     "FALSE": ["object","*[,,object]"], 
  ...
  "objectListPath" : {
     ...
     "TRIPLE_REF": ["objectPath","*[,,objectPath]"],
     "EMB_TRIPLE_REF": ["objectPath","*[,,objectPath]"],
  ...
  "objectPath" : {
     ...
     "TRIPLE_REF": ["graphNodePath"],
     "EMB_TRIPLE_REF": ["graphNodePath"],
     "TRUE": ["graphNodePath"], 
     "FALSE": ["graphNodePath"], 
  ...
  "or([*,expression])" : {
     ...
     "NOT": ["expression"], 
     "IRI_REF": ["expression"],
     "TRIPLE_REF": ["expression"],
     "EMB_TRIPLE_REF": ["expression"],
  ...
  "or([+varOrIRIref,*])" : {
     ...
     "VAR2": ["+varOrIRIref"], 
     "IRI_REF": ["+varOrIRIref"],
     "TRIPLE_REF": ["+varOrIRIref"],
     "EMB_TRIPLE_REF": ["+varOrIRIref"],
  ...
  "or([defaultGraphClause,namedGraphClause])" : {
     ...
     "TRIPLE_REF": ["defaultGraphClause"],
     "EMB_TRIPLE_REF": ["defaultGraphClause"],
  ...
  "or([subSelect,groupGraphPatternSub])" : {
     ...
     "TRIPLE_REF": ["groupGraphPatternSub"],
     "EMB_TRIPLE_REF": ["groupGraphPatternSub"],
  ...
  "primaryExpression" : {
     ...
     "TRIPLE_REF": ["embTripleRefOrFunction"],
     "EMB_TRIPLE_REF": ["embTripleRefOrFunction"],
  ...
  "propertyList" : {
     ...
     "TRIPLE_REF": ["propertyListNotEmpty"],
     "EMB_TRIPLE_REF": ["propertyListNotEmpty"],
  ...
  "propertyListNotEmpty" : {
     ...
     "TRIPLE_REF": ["or([verbPath,verbSimple])","objectList","*[;,?[or([verbPath,verbSimple]),objectList]]"],
     "EMB_TRIPLE_REF": ["or([verbPath,verbSimple])","objectList","*[;,?[or([verbPath,verbSimple]),objectList]]"],
  ...
  "propertyListPathNotEmpty" : {
     ...
     "TRIPLE_REF": ["or([verbPath,verbSimple])","objectListPath","*[;,?[or([verbPath,verbSimple]),objectList]]"],
     "EMB_TRIPLE_REF": ["or([verbPath,verbSimple])","objectListPath","*[;,?[or([verbPath,verbSimple]),objectList]]"],
  ...
  "quads" : {
     ...
     "TRIPLE_REF": ["?triplesTemplate","*[quadsNotTriples,?.,?triplesTemplate]"],
     "EMB_TRIPLE_REF": ["?triplesTemplate","*[quadsNotTriples,?.,?triplesTemplate]"],
  ...
  "relationalExpression" : {
     ...
     "TRIPLE_REF": ["numericExpression","?or([[=,numericExpression],[!=,numericExpression],[<,numericExpression],[>,numericExpression],[<=,numericExpression],[>=,numericExpression],[IN,expressionList],[NOT,IN,expressionList]])"],
     "EMB_TRIPLE_REF": ["numericExpression","?or([[=,numericExpression],[!=,numericExpression],[<,numericExpression],[>,numericExpression],[<=,numericExpression],[>=,numericExpression],[IN,expressionList],[NOT,IN,expressionList]])"],
  ...
  "triplesBlock" : {
     ...
     "TRIPLE_REF": ["triplesSameSubjectPath","?[.,?triplesBlock]"],
     "EMB_TRIPLE_REF": ["triplesSameSubjectPath","?[.,?triplesBlock]"],
  ...
  "triplesSameSubject" : {
     ...
     "TRIPLE_REF": ["varOrTerm","propertyListNotEmpty"],
     "EMB_TRIPLE_REF": ["varOrTerm","propertyListNotEmpty"],
  ...
  "triplesSameSubjectPath" : {
     ...
     "TRIPLE_REF": ["varOrTerm","propertyListPathNotEmpty"],
     "EMB_TRIPLE_REF": ["varOrTerm","propertyListPathNotEmpty"],
  ...
  "triplesTemplate" : {
     ...
     "TRIPLE_REF": ["triplesSameSubject","?[.,?triplesTemplate]"],
     "EMB_TRIPLE_REF": ["triplesSameSubject","?[.,?triplesTemplate]"],
  ...
  "unaryExpression" : {
     ...
     "TRIPLE_REF": ["primaryExpression"],
     "EMB_TRIPLE_REF": ["primaryExpression"],
  ...
  "valueLogical" : {
     ...
     "TRIPLE_REF": ["relationalExpression"],
     "EMB_TRIPLE_REF": ["relationalExpression"],
  ...
  "varOrTerm" : {
     ...
     "NIL": ["graphTerm"], 
     "IRI_REF": ["graphTerm"],
     "TRIPLE_REF": ["graphTerm"],
     "EMB_TRIPLE_REF": ["graphTerm"],
     "TRUE": ["graphTerm"], 
     "FALSE": ["graphTerm"], 
